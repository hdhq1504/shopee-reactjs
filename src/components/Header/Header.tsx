            ...
            renderPopover={
              <div className='relative rounded-sm border border-gray-200 bg-white shadow-md'>
                <div className='flex flex-col py-2 pr-28 pl-3'>
                  <button className='hover:text-orange px-3 py-2'>Tiếng Việt</button>
                  <button className='hover:text-orange mt-2 px-3 py-2'>English</button>
                </div>
              </div>
            }
          >
          ...
          <form className='col-span-9' onSubmit={onSubmitSearch}>
            <div className='flex rounded-sm bg-white p-1'>
              <input
                ...
                {...register('name')}
              />
              <button className='bg-orange shrink-0 rounded-sm px-6 py-2 hover:opacity-90'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='none'
                  viewBox='0 0 24 24'
          ...
          <div className='col-span-1 justify-self-end'>
                  ...
                  {purchasesInCart ? (
                    <div className='p-2'>
                      ...
                      <div className='mt-6 flex items-center justify-between'>
                        ...
                        <button className='bg-orange hover:bg-opacity-90 rounded-sm px-4 py-2 text-white capitalize'>
                          Xem giỏ hàng
                        </button>
                      </div>
                    </div>
            ...
            >
              <Link to='/' className='relative'>
                ...
                <span className='text-orange absolute top-[-5px] left-[17px] rounded-full bg-white px-[9px] py-px text-xs'>
